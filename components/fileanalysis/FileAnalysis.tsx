...
const FileAnalysis = ({ data, files }: { data: any, files: any }) => {
    ...
    return (
        <main className='w-full h-screen min-h-screen'>
            ...
            <div className={`text-gray-600 grid transition-all duration-300 ease-in-out ${
                leftSidebarActive && rightSidebarActive ? "grid-cols-[18%_62%_20%]" : 
                  ...
                  <div className='flex flex-col justify-center w-full max-w-3xl'>
                    ...
                    {!leftSidebarActive && (
                        <div 
                            ...
                            className='absolute top-2 left-2 bg-gray-200 p-1 rounded cursor-pointer hover:bg-gray-300 transition-all duration-200 z-10'
                        >
                            <PanelRight className='h-6 w-6 text-gray-600'/>
                        </div>
                    )}
                      ...
                      {!rightSidebarActive && (
                        <div 
                            ...
                            className='absolute top-2 right-2 bg-gray-200 p-1 rounded cursor-pointer hover:bg-gray-300 transition-all duration-200 z-10'
                        >
                            <PanelRight className='h-6 w-6'/>
                        </div>
                    )}
                    ...
                    <div className='bg-gray-100 py-2 px-4'>
                        {
                            messages.length > 0 ? <div className='flex gap-2 px-4 py-1 rounded-full bg-white border border-gray-200 items-center w-full'>
