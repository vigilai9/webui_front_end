  ...
  return (
    <nav
      className={`z-50 w-full transition-all duration-500 ${
        hasScrolled ? 'fixed top-2 px-2' : 'fixed top-0 left-0 right-0'
      }`}
    >
      <div
      ...
      >
          ...
          >
            <ul className='flex items-center gap-6 lg:gap-8 text-gray-500'>
              <li
                ...
                className='cursor-pointer text-sm option hover-underline'
              >
                Features
            ...
            {pathName === '/' && (
              <motion.div className='flex items-center justify-center'>
                <Button
                  size={'sm'}
                  variant={'outline'}
                  className='rounded cursor-pointer py-4 bg-white'
                >
                  Get Started
                </Button>
              </motion.div>
        ...
        {isMobileMenuOpen && (
          <div
            className={`md:hidden bg-white/95 backdrop-blur-sm shadow-lg mt-4 transition-all duration-300 ease-in-out ${
