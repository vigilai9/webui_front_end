...
export const FileUpload = ({
  ...
  return (
    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="relative w-6 h-6 bg-gray-200 rounded-full cursor-pointer">
             <img 
                ...
                />
          {isOpen && (
        <div ref={menuRef} className="absolute top-10 right-0 w-72 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden z-10 ">
          <div className="px-6 py-2 bg-gray-100 text-white">
            <div className="flex items-center mb-2">
              <div className="w-12 h-12 rounded-full bg-white/20 overflow-hidden mr-4">
                <img 
                  src="https://images.pexels.com/photos/45201/kitty-cat-kitten-pet-45201.jpeg?auto=compress&cs=tinysrgb&w=600" 
                  alt="Profile" 
          ...
          <div className="p-3">
            <button className="flex items-center space-x-3 w-full p-3 text-left hover:bg-gray-100 rounded-md">
            ...
            <button className="flex items-center space-x-3 w-full p-3 text-left hover:bg-gray-100 rounded-md text-red-500">
              <LogOut size={18} />
              <span>Sign out</span>
            </button>
          </div>
      ...
      {/* Content Area */}
       <main className="flex-1 justify-center items-center h-full p-4 overflow-auto bg-white">
        ...
        <div className="border-b border-gray-100 py-4">
          <div
            className="border-2 border-dashed border-gray-200 hover:border-indigo-300 bg-gray-50 hover:bg-gray-100 cursor-pointer tranisitio-all duration-500 rounded-lg p-6"
            {...getRootProps()}
          >
            <div
