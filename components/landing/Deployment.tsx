...
const cards = [
    ...
    },
    {
        ...
        description: "All the cameras that you want, speak to each other live. Each camera knows what others have seen."
    },
    {
        id: 2,
        ...
        <div className="w-full max-w-7xl lg:px-0 md:px-2 sm:px-2 px-2">
            ...
            >
                ...
                <div className="flex items-center space-x-2 bg-gray-200 w-fit rounded px-2 py-1 text-sm">
                    ...
                    <span className="text-blue-800 font-semibold">Digital Intelligence</span>
                </div>
                                        ...
                                        <div className="relative w-full h-full transition-transform duration-500 transform-style-3d group-hover:rotate-y-180">
                                            ...
                                            >
                                                <div className="flex items-center gap-2 mb-2">
                                                    {card.icon}
                                                    <h2 className="text-gray-800 font-semibold text-sm md:text-base">{card.title}</h2>
                                                </div>
                                            </div>
