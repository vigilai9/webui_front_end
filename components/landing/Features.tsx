...
const features: IFeature[] = [
  {
    ...
    description:
      'The data at all times travel through encryped channels, inaccessible to anyone unwanted.',
  },
  {
    icon: SlidersHorizontal,
    title: 'Multitier Access Control',
    description:
      'In many situations you want to allow only certain sections of your taskforce to access certain video feeds or evidence.',
  },
  {
    icon: Cpu,
    title: 'In House Processing',
    description:
      'No video feeds ever go to third parties, and we follow industry-best standards at all times.',
  },
  {
    icon: Lock,
    title: 'Encrypt Facial Data.',
    description:
      'Organizations will have option to encrypt the facial data at start and decrypt it only in specific situations when deploying at certain scenarios.',
  },
  {
    icon: MessageSquare,
    title: 'Immutable Chats',
    description:
      'Keep chats immutable so the team can monitor them and prevent misuse.',
  },
  {
    icon: EarthLock,
    title: 'Your data is Yours',
    description:
      'We never use your video feeds to improve our system without your permission, and we handle your sensitive data with utmost care.',
  },
]

const FeatureCard: React.FC<IFeature> = ({
  icon: Icon,
  title,
  description,
  className,
  ...
  return (
    <div
      className={`bg-white rounded-lg option hover-underline-feature group ${className}`}
    >
      ...
      >
        ...
        <div className='flex flex-col items-center text-center gap-4 w-full'>
          ...
          <p className='max-w-2xl text-gray-600 text-sm sm:text-base px-4 sm:px-0'>
            Trust stands supreme in the security domain. We know it and commit
