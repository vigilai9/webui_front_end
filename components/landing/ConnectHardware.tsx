...
const contents = [
    ...
    },
    {
        ...
        description: "Unlock instance analytics access for real-time insights on every event.",
    },
    {
        id: 3,
        title: "See the source, not just analysis",
        description: "Our timestamp and source cited analysis gives easy access and navigation to the original material for maximum credibility.",
    }
]
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`absolute inset-0 w-full h-full transition-all duration-500 ease-in-out ${
                                                    image.id === currentIndex ? 'opacity-100 z-10' : 'opacity-0 z-0'
                                                } ${positionClass}`}
                                            >
                                                <img
                                                    src={image.image}
                                    ...
                                    {images.map((image) => (
                                        <div
                                            ...
                                            className={`h-2 rounded-full transition-all duration-500 ${
                                                currentIndex === image.id ? "w-6 bg-gray-400" : "w-2 bg-gray-300"
                                            }`}
                                        ></div>
                                    ))}
                                </div>
...
export default ConnectHardware;4